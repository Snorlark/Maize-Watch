...
def load_live_data_from_mongodb():
    ...
    try:
        ...
        mongodb_uri = os.getenv("MONGODB_IOT_URI", "mongodb+srv://larksigmuondbabao:REDACTED@maizewatch-db.snrxrjs.mongodb.net/iot_monitoring_db?retryWrites=true&w=majority&appName=maizewatch-db")
