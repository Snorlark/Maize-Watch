...
async function testActivityLog() {
  try {
    ...
    // Connect to MongoDB
    await mongoose.connect('mongodb+srv://larksigmuondbabao:REDACTED@maizewatch-db.snrxrjs.mongodb.net/iot_monitoring_db?retryWrites=true&w=majority&appName=maizewatch-db');
