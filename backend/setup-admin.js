...
async function setupAdmin() {
  // MongoDB connection
  const client = new MongoClient('mongodb+srv://larksigmuondbabao:REDACTED@maizewatch-db.snrxrjs.mongodb.net/maizewatch?retryWrites=true&w=majority&appName=maizewatch-db');
