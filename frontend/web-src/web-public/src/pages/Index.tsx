        ...
        <div className="bg-[url(/images/background.png)] rounded-bl-[50px] rounded-br-[50px] rounded-tl-none rounded-tr-none relative h-197 bg-cover bg-center flex items-center justify-center">
          ...
          <div className="relative flex flex-col items-center justify-center text-white text-center space-y-4 md:space-y-6 w-full px-4">
            ...
            <div 
              ...
              }} className="animate-bounce mt-2 md:mt-4 px-6 hover:animate-none cursor-pointer md:px-8 py-3 md:py-3 border-2 border-white text-white rounded-full hover:scale-108 hover:bg-white hover:text-maize-dgreen transition-all ease-in-out duration-300 text-base md:text-lg font-medium" >
                See more ↓
              </button>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div className=" ml-10  space-y-6">
                  ...
                  <div  data-aos="fade" data-aos-delay="500" className="flex items-center gap-5 md:gap-70 lg:gap-20 xl:gap-90  ">
                    <button onClick={() => navigate('/solutions')} className="cursor-pointer flex items-center gap-2 text-lg font-semibold text-maize-dgreen border-b-2 border-maize-dgreen hover:border-maize-lgreen hover:text-maize-lgreen transition-all ease-in-out duration-300 pb-1">
                      LEARN MORE
                    ...
                    <div className="flex gap-4">
                      <button 
                        ...
                        className="cursor-pointer w-12 h-12 rounded-full border-2 border-maize-dgreen flex items-center justify-center hover:bg-maize-llgreen hover:text-white transition-discrete ease-in-out duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-maize-dgreen" fill="none" viewBox="0 0 24 24" stroke="currentColor">
