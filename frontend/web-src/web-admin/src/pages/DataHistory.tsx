  ...
  return (
    <div className="bg-[#E6F0D3] min-h-screen font-sans text-[#356B2C] px-4 sm:px-6 lg:px-8 pt-6 pb-8">
      <main className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-xl font-bold text-[#1E441E] mb-2 flex items-center gap-3">
            <LayoutDashboard className="w-8 h-8 text-[#456C2D]" />
            Data History
          </h1>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-lg font-semibold text-[#1E441E]">
                  Temperature Trends
                </h2>
              </div>
              <TemperatureChart />
