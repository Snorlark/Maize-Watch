...
const HumidityDashboard = () => {
  ...
  const renderChart = () => {
    ...
    const thresholdLines = [
      <ReferenceLine key="min" y={HUMIDITY_THRESHOLDS.min} stroke="green" strokeDasharray="3 3" />,
      <ReferenceLine key="max" y={HUMIDITY_THRESHOLDS.max} stroke="orange" strokeDasharray="3 3" />,
      <ReferenceLine key="critical" y={HUMIDITY_THRESHOLDS.critical} stroke="red" strokeDasharray="3 3" />,
    ];
