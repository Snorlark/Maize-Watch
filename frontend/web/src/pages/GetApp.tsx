...
export default function GetAppPage() {
  ...
  return (
    <main className="lg:h-full bg-(--color-white) lg:px-10 xl:px-20">
      <div className="pt-32 rounded-bl-[50px] rounded-br-[50px] rounded-tl-none rounded-tr-none relative h-197 bg-cover bg-center flex items-center justify-center">
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative flex justify-center items-center">
                <div
                  data-aos="fade-right"
                  className="bg-transparent w-[300px] h-[300px] md:w-[400px] md:h-[400px] rounded-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-15 transition-discrete ease-in-out duration-500"
                ></div>
                <img
                  data-aos="zoom-in"
              ...
              <div className="ml-2 space-y-6">
                <p
                  data-aos="fade-left"
                  data-aos-delay="300"
                  className="text-(--color-dgreen) text-2xl md:text-4xl lg:text-5xl font-extrabold leading-tight"
                >
                ...
                <p
                  data-aos="fade-left"
                  data-aos-delay="300"
                  className="text-(--color-dgreen) text-xl md:text-2xl italic"
                >
                ...
                <div data-aos="fade-up" data-aos-delay="300" className="mx-auto flex">
                  <button
                    ...
                    className="bg-(--color-green) text-(--color-white) px-4 md:px-7 w-40 py-2 md:py-3 rounded-md text-base md:text-lg font-semibold cursor-pointer hover:bg-(--color-dgreen) mx-5 ease-in-out duration-250 flex items-center justify-center gap-2"
                  >
                ...
                <div data-aos="fade-up" data-aos-delay="300" className="mt-8 space-y-4">
                  <div className="bg-(--color-lightgreen) bg-opacity-10 p-6 rounded-lg">
                    <h3 className="text-(--color-dgreen) text-xl font-bold mb-4">
                      App Specifications
                    </h3>
...
//   return (
//     <>
//       <body className="pt-30 lg:px-10 xl:px-20 bg-(--color-white) lg:h-screen lg:overflow-hidden">
...
//                         <div data-aos="fade-right"  className="bg-transparent
...
//                     <p data-aos="fade-left" data-aos-delay="300" className=" text-(--color-dgreen) text-2xl md:text-4xl lg:text-5xl font-extrabold leading-tight">
//                         Download the app now!
//                     </p>
//                     <p data-aos="fade-left" data-aos-delay="300" className=" text-(--color-dgreen) text-1xl md:text-2xl font-regular italic leading-tight">
//                         Maximize your yields, minimize your worries.
//                     </p> <br/>
//                         <div data-aos="fade-up" data-aos-delay="300"  className="mx-auto flex">
