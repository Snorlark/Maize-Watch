        ...
        <main>
              ...
              <div className="space-y-6">
                <div className="inline-block items-center gap-3">
                  ...
                  {/* <div className="relative w-full h-full">
                    <img src="/images/container-solutions.png" alt="Container" className="w-full h-full" />
                    <div className="absolute top-4 left-4 pt-4 pl-2 text-white">
                      <h1 className="text-3xl md:text-[30px] font-bold ">
                        Our Mission.
                      </h1>
                      <div className="flex items-start gap-4 mt-2 md:mt-6 mr-30 md:mr-10  ">
                  ...
                  <div className='pt-5 pb-5'>
                    <div className="bg-[url('/images/container-solutions-2.png')] bg-cover bg-center text-white p-6 rounded-xl pt-5 pb-5">
          ...
          <section className="py-12 px-4 md:px-20">
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-4 md:px-20 lg:px-40">
              <div>
                <h2 className="text-6xl font-bold text-(--color-dgreen) mb-4">The Problem.</h2>
