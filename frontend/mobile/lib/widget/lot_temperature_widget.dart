...
class LotTemperatureWidget extends StatefulWidget {
  const LotTemperatureWidget({super.key});

  @override
  State<LotTemperatureWidget> createState() => _LotTemperatureWidgetState();
}

class _LotTemperatureWidgetState extends State<LotTemperatureWidget> {
        ...
        children: [
          ...
          SfCartesianChart(
            ...
            primaryXAxis: CategoryAxis(
              labelStyle: const TextStyle(color: Colors.black), // White text for category labels
              majorGridLines: const MajorGridLines(width: 0), // Removes vertical grid lines
            ),
