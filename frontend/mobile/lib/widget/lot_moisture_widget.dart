...
class LotMoistureWidget extends StatefulWidget {
  const LotMoistureWidget({super.key});

  @override
  State<LotMoistureWidget> createState() => _LotMoistureWidgetState();
}

class _LotMoistureWidgetState extends State<LotMoistureWidget> {
