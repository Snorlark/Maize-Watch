...
const SoilPhLevelChart = () => {
  ...
  return (
    <div className="bg-[#E6F0D3] p-4 rounded-2xl">
      <h2 className="text-[#356B2C] text-lg font-semibold mb-2">Soil Ph Level</h2>
      ...
      <div className="flex justify-between items-center mb-3">
        ...
        <div className="relative group">
          ...
          <div className="absolute right-0 mt-1 bg-white border border-[#356B2C] rounded shadow-md text-xs hidden group-hover:block z-10">
            <button onClick={() => handleExport("pdf", chartRef.current, chartData, xKey, "Soil Ph Level")} className="block px-4 py-2 hover:bg-[#E6F0D3] w-full text-left">PDF</button>
            <button onClick={() => handleExport("csv", chartRef.current, chartData, xKey, "Soil Ph Level")} className="block px-4 py-2 hover:bg-[#E6F0D3] w-full text-left">CSV</button>
            <button onClick={() => handleExport("svg", chartRef.current, chartData, xKey, "Soil Ph Level")} className="block px-4 py-2 hover:bg-[#E6F0D3] w-full text-left">SVG</button>
          </div>
        </div>
      </div>
...
export default SoilPhLevelChart;